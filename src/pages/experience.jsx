            ...
            <div className='container mx-auto flex flex-col justify-center min-1100:p-10'>
                ...
                <div className={`bg-black border ${theme == 'blue' ? 'border-base_clr shadow-[0_0_20px_#00f6ff]' : 'border-base_clr_1 shadow-[0_0_20px_#fa0c0c]'}  p-4  rounded-md capitalize mt-10 w-full mx-auto flex flex-col justify-center gap-y-2`}>
                    <div className='flex flex-col justify-center w-auto gap-y-1'>
                        <h1 className={`${theme == 'blue' ? 'text-base_clr' : 'text-base_clr_1'}  text-3xl min-600:text-2xl font-bold`}>Full stack developer</h1>
                    ...
                    <div className='flex flex-col gap-y-2'>
                        <h1 className={`text-3xl min-600:text-2xl font-bold ${theme == 'blue' ? 'text-base_clr' : 'text-base_clr_1'}`}>frontend</h1>
                        <p className='text-lg min-700:text-md font-medium'>{frontEnd}</p>
                    </div>
                    <div className='flex flex-col gap-y-2'>
                        <h1 className={`text-3xl min-600:text-2xl font-bold ${theme == 'blue' ? 'text-base_clr' : 'text-base_clr_1'}`}>backend</h1>
