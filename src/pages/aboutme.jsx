    ...
    return (
        <>
            <section className='container flex  mx-auto '>
                <div className={`w-1/2 p-5  flex flex-col justify-center items-center ${isVisible ? 'animate-slide_left' : ''} `}>
                ...
                <div className={`w-1/2 flex justify-center ${isVisible ? 'animate-slide_rgt' : ''}`}>
