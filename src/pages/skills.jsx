...
const skillData = [
    {
        id: 1, logo: '</>', role: "Frontend Development",
        language: [
    ...
    {
        id: 2, logo: <FaServer />, role: "Backend Development",
        language: [
    ...
    {
        id: 3, logo: <FaDatabase />, role: "Database Specialized",
        language: [
        ...
        <>
            <div className='container mx-auto mt-16 p-3'>
                ...
                <div className='mt-16 flex gap-x-10'>
                    {skillData.map((a) => (<div key={a.id} className='hover:scale-105 hover:cursor-pointer duration-300 border border-base_clr w-full h-auto p-7 rounded-lg shadow-[0_0_20px_#00f6ff] bg-black mb-5'>
                        <p className='text-7xl text-base_clr font-bold '>{a.logo}</p>
                        <p className='font-medium text-3xl mt-5 capitalize'>{a.role}</p>
                        {a.language.map((b) => (<div className='mt-2 '>
